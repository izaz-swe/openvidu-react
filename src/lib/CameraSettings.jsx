...
import Desk from '../public/background-images/samantha-gades-BlIhVfXbi9s-unsplash.jpeg';
import Nature from '../public/background-images/ali-kazal-tbw_KQE3Cbg-unsplash.jpeg';
...
export function CameraSettings() {
  ...
  const [backgroundType, setBackgroundType] = React.useState(() => {
    const procName = cameraTrack?.track?.getProcessor?.()?.name;
    if (procName === 'background-blur') return 'blur';
    if (procName === 'virtual-background') return 'image';
    return 'none';
  });
